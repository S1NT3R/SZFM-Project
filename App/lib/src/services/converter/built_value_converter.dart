...
class BuiltValueConverter extends JsonConverter {
  static const bool forcedLogging = true;

  @override
  Request convertRequest(Request request) {
    try {
      if (forcedLogging) {
        for (var e in request.parts) {
          debugPrint("Part: ${e.name}:${e.value}");
        }
      }
  ...
  FutureOr<Response<BodyType>> convertResponse<BodyType, InnerType>(
    ...
    try {
      ...
      debugPrint("Response parse failed");
  ...
  Map<String, Object> removeNullAndEmptyParams(
      Map<String, Object> mapToEditParam) {
    Map<String, Object> mapToEdit = mapToEditParam;
// Remove all null values; they cause validation errors
  ...
  List<Object?> removeNullAndEmptyParamsInList(List<Object?> mapToEditParam) {
    List<Object?> listToEdit = mapToEditParam;
// Remove all null values; they cause validation errors
